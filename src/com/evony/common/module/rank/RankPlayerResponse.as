...
public class RankPlayerResponse extends BaseBean {

    public function RankPlayerResponse(param1:String, param2:Object, param3:Boolean = false, param4:Boolean = false) {
        ...
        if (param2.beans) {
            for each(_loc5_ in param2.beans) {
                this.beansArray.addItem(new PlayerInfoBean(_loc5_));
            }
        }
